...
# evaulation
nohup /home/lazarosg/miniconda3/envs/ijepa/bin/python main.py --fname configs/iic-eval.yaml --devices cuda:0 --eval 1 &> logs_PKT_chunks_different_seeds/iic-train-l2-seed3/o-EVAL.out &